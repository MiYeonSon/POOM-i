...
import FindRearingEditorContainer from "../../containers/childcare/write/FindRearingEditorContainer";
import FindClassEditorContainer from "../../containers/poom-class/write/FindClassEditorContainer";
import FindClassWriteActionButtonsContainer
    from "../../containers/poom-class/write/FindClassWriteActionButtonsContainer";
...
const NewPostInput = ({children, content}) => {
    ...
    const form = content === 'childcare' ? <FindRearingEditorContainer /> : <FindClassEditorContainer />;
