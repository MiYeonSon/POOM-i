...
// 액션 타입 정의
const INITIALIZE = 'expertWrite/INITIALIZE';  // 모든 내용 초기화
const CHANGE_FILED = 'expertWrite/CHANGE_FIELD';  // 특정 key 값 바꾸기
const SET_ORIGINAL_POST = 'expertWrite/SET_ORIGINAL_POST';// 수정 시 post 상태를 write로 복사
...
const [
    ...
    WRITE_POST_SUCCESS,
    WRITE_POST_FAILURE
] = createRequestActionTypes('expertWrite/WRITE_POST');
...
const [
    ...
    UPDATE_POST_SUCCESS,
    UPDATE_POST_FAILURE
] = createRequestActionTypes('expertWrite/UPDATE_POST');
...
export const updatePostSaga = createRequestSaga(UPDATE_POST, postsAPI.updatePost);
 ...
 */
const expertWrite = handleActions(
    {
